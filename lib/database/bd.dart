...
class SqlDb {
  ...
  //Update
  static Future<int> atualizaItem(int id, String title,
  ...
  //Delete
  static Future<List<Map<String, dynamic>>> deleteItem(int id) async {
    final db = await SqlDb.db();

    try {
      await db.delete("items", where: "id = ?", whereArgs: [id]);
    } catch (err) {
      debugPrint("Algo que deu errado na exclusão do item: $err");
    }
  }
}
